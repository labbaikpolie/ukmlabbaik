                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-1">
                                ...
                                <form action="/admin/syiar/{{ $item->id }}" method="post" class="delete-form m-0">
                                    @method('DELETE')
                                    @csrf
                        ...
                        <div class="modal-dialog bg-white">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="/admin/syiar/{{ $item->id }}" method="post"
                        ...
                        button.addEventListener('click', function(event) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    this.parentNode.action = '/admin/syiar/' + id;
...
<div class="modal fade" id="addNew" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: white">
            ...
            <div class="modal-body">
                <form action="/admin/saveSyiar" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="nama" class="mb-1">Nama</label>
                        <input type="text" class="form-control" id="nama" name="nama"
